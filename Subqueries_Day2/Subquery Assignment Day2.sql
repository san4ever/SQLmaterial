--Q
-- Display Employee name , JOB name , Department name using Subquery. use subquery as a inline view for inner join
-- Repeat the same using with clause.


--Q
-- Display Employee name , Department name and city using Subquery. use subquery as a inline view for inner join
-- Repeat the same using with clause.


--Q
-- Display Department name , city , country and region using Subquery. use subquery as a inline view for inner join
-- Repeat the same using with clause.


--Q 
-- Display employee name, salary if  emp salary is greater than avg of the department he is working. use Corelated sub query
-- Repeat same with with clause.
